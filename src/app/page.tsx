      ...
      >
        ...
        <main className="flex flex-col gap-8 row-start-2 items-center sm:items-center relative z-10 w-full max-w-4xl">
          ...
          >
            ...
            <div className="flex flex-col items-center py-12 px-4">
              <img
                src="/slides/tusday.jpeg"
                alt="Tuesday Intercession"
                className="max-h-[600px] w-auto object-contain"
              />
            </div>
            <div className="flex flex-col items-center py-12 px-4">
              <img
                src="/slides/wenesday.jpeg"
                alt="Wednesday Intercession"
                className="max-h-[600px] w-auto object-contain"
              />
            </div>
            <div className="flex flex-col items-center py-12 px-4">
        ...
        <footer className="row-start-3 flex flex-col gap-2 items-center justify-center relative z-10">
          <p className="text-white text-lg sm:text-lg text-center italic">
            &ldquo;Mas el que bebiere del agua que yo le daré, no tendrá sed
            jamás; sino que el agua que yo le daré será en él una fuente de agua
            que salte para vida eterna.&rdquo;
          </p>
